...
Pod::Spec.new do |s|
  s.name             = 'WMAnimator'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WMAnimator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Moly/WMAnimator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Moly' => 'kyounh12@snu.ac.kr' }
  s.source           = { :git => 'https://github.com/Moly/WMAnimator.git', :tag => s.version.to_s }
